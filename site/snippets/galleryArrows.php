  ...
  <div class='galleryArrowLeftContainer'>
    ...
    <svg class='galleryArrowLeft' width="28px" height="28px" viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="arrow-outline" stroke="#1E1E1E" vector-effect="non-scaling-stroke"  stroke-width="6" fill="transparent">
                <use id="arrow" vector-effect="non-scaling-stroke"  mask="url(#mask-2)" transform="translate(14.000000, 14.000000) rotate(-90.000000) translate(-14.000000, -14.000000) " xlink:href="#path-1"></use>
            </g>
        </g>
    </svg>
  </div>
